...
class ContactsControllerTest < ActionController::TestCase
  ...
  test "should create contact" do
    assert_difference('Contact.count') do
      post :create, contact: { canalingreso_id: @contact.canalingreso_id, con_apellido: @contact.con_apellido, con_boton_sitio: @contact.con_boton_sitio, con_confirmado: @contact.con_confirmado, con_mail: @contact.con_mail, con_nombre: @contact.con_nombre, con_nya: @contact.con_nya, con_obs: @contact.con_obs, con_password2: @contact.con_password2, con_password: @contact.con_password, con_password_confirmacion: @contact.con_password_confirmacion, con_suscribir: @contact.con_suscribir, con_telefono: @contact.con_telefono, con_telefono_sn: @contact.con_telefono_sn, option_id: @contact.option_id, profile_id: @contact.profile_id }
    end
